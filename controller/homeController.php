...
AS date_arrivee, places_dispo, depart.ville AS depart, arrivee.ville AS arrivee FROM trajets JOIN agences AS depart ON 
...
if ($resultat -> num_rows > 0) {
    ...
    echo '<p class="text-center">Aucun trajet disponible pour le moment.</p>';
}
$conn->close();
?>